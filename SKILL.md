...
This skill allows me to control your smart home devices directly using a Python-based bridge to the Google Assistant SDK.
...
1.  **Environment:** Create a Python virtual environment at `/home/tvd/.openclaw/workspace/project_env`.
...
- **Example:** `PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python /path/to/project_env/bin/python3 [SKILL_PATH]/scripts/control.py "turn off the lights"`

## 📍 Confirmed Devices
- **Office:** Lights/Power.
- **Loungeroom:** Lights/TV.
